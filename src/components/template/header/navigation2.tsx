          ...
          {(
            ...
            .map((item) => (
              ...
              >
                <Link
                  href={item.link}
                  class="text-text1 hover:bg-surface2 hover:text-text1 flex items-center justify-center rounded-md px-3 py-2"
                >
                  {item.name}
                </Link>
              </div>
        ...
        <div class="flex h-16 items-center justify-between">
                ...
                {(
                  ...
                  .map((item) => (
                    <li key={item.link}>
                      <Link
                        href={item.link}
                        class="text-text1 hover:bg-surface2 hover:text-text1 rounded-md px-3 py-2 text-sm font-medium"
                      >
                        {item.name}
                      </Link>
                    </li>
          ...
          <div class="hidden lg:block">
            <div class="flex md:ml-6">
              <button
                type="button"
                class="text-text2 hover:text-text1 focus:outline-brand-core mr-4 ml-4 flex items-center justify-center rounded-full p-1 focus:outline-2 focus:outline-offset-2"
              >
              ...
              <button
                ...
                type="button"
                class="text-text2 hover:text-text1 focus:outline-brand-core relative mr-4 rounded-full p-1 focus:outline-2 focus:outline-offset-2"
              >
              ...
              <el-dropdown class="relative ml-3">
                ...
                >
                  <a
                    href="#"
                    class="text-text2 focus:bg-surface3 block px-4 py-2 text-sm focus:outline-hidden"
                  >
                    Your profile
                  </a>
                  <a
          ...
          <div class="-mr-2 flex lg:hidden">
            <button
              type="button"
              class="text-text2 hover:text-text1 focus:outline-brand-core inline-flex items-center justify-center rounded-md p-2 focus:outline-2 focus:outline-offset-2"
