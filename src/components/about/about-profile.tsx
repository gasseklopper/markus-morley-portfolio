...
export const AboutProfile = component$(() => {
  return (
    <section class="layout-shell relative mt-16 w-full overflow-hidden rounded-3xl border border-[var(--surface-border)] bg-[radial-gradient(circle_at_top,_var(--surface2)_0%,_var(--surface1)_70%)] px-6 py-12 text-[var(--text1)] shadow-[0_32px_120px_var(--surface-shadow)] transition-colors duration-300 [container-name:about-profile] [container-type:inline-size] md:px-12">
      <div class="grid gap-12 @[75rem]:grid-cols-[minmax(0,320px)_minmax(0,1fr)] @[75rem]:items-start @[90rem]:grid-cols-[minmax(0,360px)_minmax(0,1fr)]">
        ...
        <div class="flex flex-col gap-12 [container-type:inline-size] @[75rem]:grid @[75rem]:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] @[75rem]:items-start @[75rem]:gap-10">
          <article class="rounded-[2.5rem] border border-[var(--surface-border)] bg-[var(--surface-glass-2)] p-8 text-[var(--text2)] shadow-[0_20px_70px_var(--surface-shadow)] transition-colors duration-300 @[75rem]:h-full @[75rem]:self-stretch">
            ...
            <dl class="mt-8 grid gap-4 @[40rem]:grid-cols-2 @[75rem]:grid-cols-3">
          ...
          <article class="rounded-[2.5rem] border border-[var(--surface-border)] bg-[var(--surface-glass-2)] p-8 text-[var(--text2)] shadow-[0_20px_70px_var(--surface-shadow)] transition-colors duration-300 @[75rem]:h-full @[75rem]:self-stretch">
            ...
            <div class="grid gap-6 @[40rem]:grid-cols-2 @[75rem]:grid-cols-3 @[95rem]:grid-cols-4">
